...
export default {
  ...
  thisIsAchievedBySeparating: 'This is achieved by known HTML elements tree structure and separating the concepts of Grid (which can be added, removed, copied, saved, moved and style edited with CSS properties) and Text (individual text blocks: with Grid functionality plus text editing).',
  home: 'Home',
  ...
  everyContentBlockHasItsOwn: 'Every Grid block has its owns style based on CSS properties. The right-side panel automatically switches to a property panel for the selected Grid element. There element can be adjusted by specific style property, saved, copied or deleted.',
  ...
  goToTheLink: 'Go to the link',
  andFollowInstructions: 'and follow instructions how to install and use it.'
};
