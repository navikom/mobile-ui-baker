...
export default {
  ...
  startFromWhitePage: 'Start from white page',
  ...
  muiditorStandsForBest: 'FacetsUI stands for "Best Mobile UI CSS based Editor".\n' +
    '            That\'s the ambitious goal that we set for this project.\n' +
    '            Made with lots of passion, FacetsUI is used both online here\n' +
    '            at Editor and can be embedded in SaaS applications as Editor or/and Viewer',
  muiditorFree: 'FacetsUI Free',
  ...
  muiditorEmbedPlugin: 'FacetsUI Embed Plugin',
  embedMuiditorEditorAndOrViewer: 'Embed FacetsUI Editor and/or Viewer to bring awesome Mobile UI creation and showing inside your Web app.',
  muiditorEmbedPluginPro: 'FacetsUI Embed Plugin Pro',
  ...
  youGetTheConfiguredUI: 'You get the configured UI, with colors, images, svg, gradients, font size etc. just like they were in the Figma design, without you having to create everything piece by piece for hours and hours. You also get screens, navigation, actions and the ability to save, share the working UI to anyone on the  browser',
  ...
  convertFigmaDesign: 'Convert Figma Design',
  downloadEditShare: 'Download, Edit & Share',
  ...
  embeddedEditor: 'Embedded Editor',
  ...
  key: 'Key',
  secret: 'Secret',
  whatIsMuiditor: 'What\'s FacetsUI?',
  aboutMuiditor: 'About FacetsUI',
  isADragNDropEditor: 'FacetsUI is a drag-n-drop CSS based editor and mobile screens viewer to build and view beautiful Mobile UI, fast.',
  ...
  youCanTranslateMobileDesignInToReactNativeSourceCode: 'You can translate Mobile Design into React Native source code.',
  aboutTheEditor: 'About the Editor.',
  makesItEasyToCreateA: 'FacetsUI makes it easy to create a Mobile UI that can be used to show pre designed Mobile interface, announce it, promote, etc. You can use it free of charge at',
  ...
  oneOfTheBiggestStrength: 'One of the biggest strengths of the FacetsUI editor is that it provides creative professionals with tremendous design flexibility.',
  ...
  whatIsMuiditorPlugin: 'What is FacetsUI Plugin?',
  isEmbeddedVersionOfEditor: 'FacetsUI Plugin is the embeddable version of the FacetsUI editor and viewer. It was created so that you can take what you see on facetsui.com/editor or facetsui.com/viewer and embed it into an application that you have created, to enable great Mobile UI editing or preview for your users.',
  isAJavaScriptPackage: 'FacetsUI Plugin is a JavaScript Package that allows you to easily embed the editor or/and viewer into your application. Installing and configuring FacetsUI Plugin only takes a few minutes.',
  ...
  onceYouHaveInitialized: 'Once you have initialized FacetsUI Plugin, you can pass a series of configuration parameters to it. The default configuration for FacetsUI Plugin should be something like the following:',
  hereIsABrief: 'Here is a brief description of the parameters:',
  property: 'Property',
  identifiesTheIdOfTheHtmlElement: 'Identifies the id of the HTML element that contains FacetsUI Plugin',
  required: 'Required',
  default: 'Default',
  yes: 'Yes',
  no: 'No',
  ...
  hideMuiditorHeader: 'Hide FacetsUI header',
  ...
  goToTheImportFromFigma: 'Go to the import from Figma',
  downloadProjectFromFigma: 'Importing from figma',
  youCanImportYourFigmaDesign: `You can import your Figma designs into FacetsUI using FacetsUI's Figma Importer.`,
  toImportFigmaProject: 'To import a Figma project, open the "Project" tab at the right of the editor and click the "Import Project" button.',
  importFigma: 'Import Figma project',
  checkFromFigmaButton: 'Click "From Figma" button',
  toImportFromFigma: 'To import from Figma you need',
  accessToken: 'access token',
  fileKey: 'file key',
  takeTheAccessToken: 'Go to the Figma website and take the access token',
  takeTheFileKey: 'Take the file key',
  ...
  isTheInstance: 'is the instance of your embedded FacetsUI plugin, here are the methods you can call',
  ...
  allTheFeatures: 'All the features & benefits of the FacetsUI',
  viewer: 'Viewer',
  plus: 'plus',
  ...
  allOfThisGivesFlexibilityAllowsToCreateOwnMarketplace: 'With Pro Plan you and your users will use editor without Advertising, also, you can customize Editor and Viewer toolbars, untie editor methods to parent facetsui.com database, override saving and switching between projects. All of this will add "Mobile UI creation" user experience into your site and even allows you to create your own Mobile UI\'s Marketplace.',
  ...
  generateReactNativeSourceCode: 'Generate React Native source code',
  convertTheMobileDesignInto: 'Convert the Mobile design into the React Native source code is easy now using FacetsUI Editor',
  tryItNowOpenTheSampleProject: 'Try it now. Open the sample project',
  andGenerateYourFirstReactNativeProject: 'generate and run your first React Native project',
  ...
  muiditorTeam: 'FacetsUI team',
  author: 'author',
  contactUs: 'Contact Us',
  fillFreeToContactUs: 'Feel free to contact us for any question about our products and services',
  whatAreYouLookingFor: 'What are you looking for?',
  beforeYouStart: 'Before you start',
  forAnyTypeOfQuestion: 'For any type of question, please use the following resources:',
  readThe: 'Read the',
  checkTheIssuesOn: 'Check the issues on',
  thePaymentPending: 'The payment pending',
  someTimesOurPaymentVendor: 'Sometimes our payment Vendor Paddle is taking longer time to process the payment. It makes sure the person who made the purchase is exactly the owner of the card/paypal to prevent internet frauds. That’s it, just some extra security checks for your account protection. Hope that makes sense and we sorry for the inconvenience.',
  letUsKnowIfThePayment: 'Please let us know if the processing payment is taking too much time and we will manually check it.',
  typeYourMessageHere: 'Type your message here',
  yourMessageWasSent: 'Your message was sent successfully!',
  verifyThatYouHaveAProPlan: 'Verify that you have an active Pro subscription. If you do not have an active subscription, your message will have a low priority for us!',
  proPlan: 'Pro plan',
  evenIfWeHaveTested: 'Even if we have tested the products and thousands of people already used them, sometimes new browser\'s versions or system configurations can cause issues on our products. Please give us as much information as you can, if you have links to your website or anything that can help us identify the bug. In 99% of the cases we give you a quick fix in the first 24 hours. Lack of details can cause delays on our side too. Please choose the way that you want to report the bug:',
  ...
  downloadOrCloneThe: 'download or clone the',
  npmProject: 'npm project',
  pressTheGenerateButton: 'press "Generate React Native Package" button',
  unzipGeneratedPackage: `unzip generated package (it's might be in the downloads folder)`,
  dragAndDropUnzipped: 'drag and drop unzipped package named "src" inside the downloaded "facetsui-react-native" project',
  pressReplaceIf: 'press "replace" if prompted',
  inTheTerminalPerform: 'in the terminal perform commands',
  openTheEmulatorInAndroidStudio: 'open the emulator in Android Studio before run the terminal command',
  runInTheTerminal: 'run in the terminal',
  compileIt: 'compile it',
  afterFewMinutesYouCan: 'After few minutes you can play with the project inside device or emulator, and the project almost ready for publishing in mobile stores',
  translateDesignInToReactNativeCode: 'Translate design into React Native code',
  mobileApplicationCreationNeverWasSoSimple: 'Mobile application creation never was so simple before',
  justPressTheButtonToConvertMobileApplicationDesignInToReact: 'Just press the button to convert the Mobile Application Design into React Native source code',
  performTheCommand: 'perform the command',
  openTheProjectInTheTerminal: 'open the project in the terminal',
