...
const defintitions = [
  ...
  ['Documentation', 'means documentation provided by FacetsUI in electronic format to the Client.'],
  ['Effective Date', 'means the date this Agreement comes into effect, as notified by FacetsUI to the Client with an email sent to the email address provided by the Client in the Registration Form and that the Client declares to periodically check.'],
  ...
  ['Harmful Code', 'means any software, hardware or other technology, device or means, including any virus, worm, malware or other malicious computer code, the purpose or effect of which is to (a) permit unauthorized access to, or to destroy, disrupt, disable, distort, or otherwise harm or impede in any manner any (i) computer, software, firmware, hardware, system or network or (ii) any application or function of any of the foregoing or the security, integrity, confidentiality or use of any data Processed thereby, or (b) prevent Client or any Authorized User from accessing or using the Services or FacetsUI Systems as intended by this Agreement. Harmful Code does not include any FacetsUI Disabling Device.'],
  ...
  ['FacetsUI Materials', 'means the Service Software, Specifications, Documentation and FacetsUI Systems and any and all other information, data, documents, materials, works and other content, devices, methods, processes, hardware, software and other technologies and inventions, including any deliverables, technical or functional descriptions, requirements, plans or reports, that are provided or used by FacetsUI or any Subcontractor in connection with the Services, including any third party materials licensed to FacetsUI, or otherwise comprise or relate to the Services or FacetsUI Systems. For the avoidance of doubt, FacetsUI Materials include Resultant Data and any information, data or other content derived from FacetsUI’s monitoring of Client’s access to or use of the Services, but do not include Client Data.'],
  ['FacetsUI Systems', 'means the information technology infrastructure used by or on behalf of FacetsUI in performing the Services, including all computers, software, hardware, databases, electronic systems (including database management systems) and networks, whether operated directly by FacetsUI or through the use of third-party services.'],
  ...
  ['Subscription Plan', 'means the specific Software subscription plan chosen by the Client among the different subscription plans available at https://facetsui.com.'],
  ['Registration Form', 'means the registration form available at https://facetsui.com/sign-up'],
  ...
  ['Service Software', 'including new versions, modifications, enhancements, improvements, updates, revisions, additions, derivative works, documentation and related material, that FacetsUI provides remote access to and use of as part of the Services.'],
  ['Subscription Fees', 'the per-Authorized User amount for the selected Subscription Plan, as listed on the pricing page on the FacetsUI Prices page at https://facetsui.com/prices, times the number of Authorized Users active during the Billing Period immediately prior to Renewal.'],
  ['Term', 'is defined in Section 7.1.'],
  ['Website', 'means https://facetsui.com, including any third-level-domain and sub-domains.']
]
...
const Terms = () => {
  ...
  return (
    <div className={classes.root}>
      <Typography>
        This agreement (the “Agreement”) is entered into between FacetsUI inc., (“FacetsUI”), acting for and on behalf
        ...
        FacetsUI and the Client individually also the “Party”, and collectively, the “Parties”.
      </Typography>
      <Typography align="center" variant="h6" className={classes.section}>WHEREAS</Typography>
      <ol type="i">
        {
          [
            'FacetsUI is a company specialized in the digital marketing and digital communications sector;',
            'Client wishes to procure from FacetsUI the software services described herein, and FacetsUI wishes to provide such services to Client, each on the terms and conditions set forth in this Agreement.'
          ].map((prop, i) => (
      ...
      <Typography>Except as otherwise expressly provided in this Agreement, as between the Parties: (a) FacetsUI has and
        will retain sole control over the operation, provision, maintenance and management of the Services and FacetsUI
        Materials, including the: (i) FacetsUI Systems; (ii) location(s) where any of the Services are performed; (iii)
        ...
        access to and use of the Services and FacetsUI Materials by any Person, including any: (i) information,
        instructions or materials provided by any of them to the Services or FacetsUI; (ii) results obtained from any
        use of the Services or FacetsUI Materials; and (iii) conclusions, decisions or actions based on such
        use.</Typography>
      <Typography variant="subtitle2" className={classes.subsection}>2.3. Changes.</Typography>
      <Typography>FacetsUI reserves the right, in its sole discretion, to make any changes to the Services and FacetsUI
        Materials that it deems necessary or useful to: (a) maintain or enhance (i) the quality or delivery of
        FacetsUI’s services to its Clients, (ii) the competitive strength of or market for FacetsUI’s services or (iii)
      ...
      <Typography variant="subtitle2" className={classes.subsection}>2.4. Suspension or Termination of
        Services.</Typography>
      <Typography>FacetsUI may, directly or indirectly, and by use of any FacetsUI Disabling Device or any other lawful
        means, suspend, terminate or otherwise deny Client’s, any Authorized User’s or any other Person’s access to or
        use of all or any part of the Services or FacetsUI Materials, without incurring any resulting obligation or
        liability, if: (a) FacetsUI receives a judicial or other governmental demand or order, subpoena or law
        enforcement request that expressly or by reasonable implication requires FacetsUI to do so; or (b) FacetsUI
        ...
        limit any of FacetsUI’s other rights or remedies, whether at law, in equity or under this
      ...
      <Typography>Subject to and conditioned on Client’s payment of the Fees and compliance and performance in
        accordance with all other terms and conditions of this Agreement, FacetsUI hereby authorizes Client to access
        and use, during the Term, the Services and such FacetsUI Materials as FacetsUI may supply or make available to
      ...
      <Typography>Nothing in this Agreement grants any right, title or interest in or to (including any license under)
        any Intellectual Property Rights in or relating to, the Services, or FacetsUI Materials, whether expressly, by
        implication, estoppel or otherwise. All right, title and interest in and to the Services and the FacetsUI
        Materials are and will remain with FacetsUI and its licensors.</Typography>
      ...
      <Typography>Client shall at all times during the Term: (a) set up, maintain and operate in good repair and in
        ...
        provide FacetsUI personnel with such access to Client Systems as is necessary for FacetsUI for troubleshooting
        and to perform the Services in accordance with the Availability Requirement and Specifications; and (c) provide
        all cooperation and assistance as FacetsUI may reasonably request to enable FacetsUI to exercise its rights and
      ...
      <Typography variant="subtitle2" className={classes.subsection}>4.2. Effect of Client Failure or
        Delay.</Typography>
      <Typography>FacetsUI is not responsible or liable for any delay or failure of performance caused in whole or in
      ...
      <Typography>If Client becomes aware of any actual or threatened activity prohibited by Section 5, Client shall,
        ...
        FacetsUI Materials and permanently erasing from their systems and destroying any data to which any of them have
        gained unauthorized access); and (b) notify FacetsUI of any such actual or threatened activity.</Typography>
      <Typography variant="subtitle1" className={classes.subsection}>5. Use Policy.</Typography>
      <ol type="a">
        {
          [
            'The Client shall not, and shall not permit any other person to, access or use the Services or FacetsUI Materials except as expressly permitted by this Agreement. For purposes of clarity and without limiting the generality of the foregoing, Client shall not, except as this Agreement expressly permits: Directly or indirectly: reverse engineer, decompile, disassemble, or otherwise attempt to access the source code of the FacetsUI Services or Materials, or underlying structure, ideas, or algorithms of the Software or any software, documentation, or data related to the Software; modify, translate, or create derivative works based on the Software, except and only to the extent that such activity is expressly permitted by this Agreement; or copy, distribute, pledge, assign, or otherwise transfer or encumber rights to the Software; rent, lease, lend, sell, sublicense, assign, distribute, publish, transfer or otherwise make available the Software to any person, including on or in connection with the use of Software for timesharing or service bureau purposes, software as a service, cloud or other technology or service; or otherwise for the benefit of a third party unless specifically authorized by FacetsUI;',
            'Bypass or breach any security device or protection used by the Services or FacetsUI Materials or access or use the Services or FacetsUI Materials other than by an Authorized User through the use of his or her own then valid Access Credentials;',
            'Remove or alter the FacetsUI’s trademarks, or any trademark, copyright or other proprietary notices, legends, symbols or labels in the Software;',
            ...
            'input, upload, transmit or otherwise provide to or through the Services or FacetsUI Systems, any information or materials that are unlawful or injurious, or contain, transmit or activate any Harmful Code;',
            'damage, destroy, disrupt, disable, impair, interfere with or otherwise impede or harm in any manner the Services, FacetsUI Systems or FacetsUI’s provision of services to any third party, in whole or in part;',
            ...
            'otherwise access or use the Services or FacetsUI Materials beyond the scope of the authorization granted under Section 3.1.'
          ].map((prop, i) => (
            <Typography key={i.toString()} component="li">{prop}</Typography>
          ))
        }
      ...
      <Typography>FacetsUI does not process any order payments through the website. All payments are processed securely through Paddle, a third party online payment provider.</Typography>
      ...
      <ol type="a">
        {
          [
            'FacetsUI may terminate this Agreement by giving written notice to the Client prior to, and effective as of, the expiration of the current Billing Period;',
            'FacetsUI may terminate this Agreement, effective on written notice to Client, if Client: (i) fails to pay;',
            ...
            'FacetsUI shall immediately cease all use of any Client Data or Client’s Confidential Information and (i) at Client’s written request destroy all documents and tangible materials containing, reflecting, incorporating or based on Client Data or Client’s Confidential Information; and (ii) upon the Client’s written request, permanently erase all Client Data and Client’s Confidential Information from all systems FacetsUI directly or indirectly controls, provided that, for clarity, FacetsUI’s obligations under this Section 7 do not apply to any Resultant Data;',
            'Client shall immediately cease all use of any Services or FacetsUI Materials and (i) at FacetsUI’s written request destroy all documents and tangible materials containing, reflecting, incorporating or based on FacetsUI’s Confidential Information; and (ii) permanently erase FacetsUI’s Confidential Information from all systems Client directly or indirectly controls;',
            'notwithstanding anything to the contrary in this Agreement, with respect to information and materials then in its possession or control: (i) the Receiving Party may retain the Disclosing Party’s Confidential Information solely to the extent and for so long as required by applicable law; (ii) FacetsUI may also retain Client Data in its backups, archives and disaster recovery systems until such Client Data is deleted in the ordinary course; and (ii) all information and materials described in this Section will remain subject to all confidentiality, security and other applicable requirements of this Agreement;',
            'FacetsUI may disable all Client and Authorized User access to the Hosted Services and FacetsUI Materials;',
            'if FacetsUI terminates this Agreement, all Fees that would have become payable had the Agreement remained in effect until expiration of the Term will become immediately due and payable, and Client shall pay such Fees, together with all previously-accrued but not yet paid Fees, on receipt of FacetsUI’s invoice therefor.'
          ].map((prop, i) => (
            <Typography key={i.toString()} component="li">{prop}</Typography>
          ))
        }
      ...
      <Typography>FacetsUI will use commercially reasonable efforts to give Client at least five (5) days prior notice of all scheduled outages of the Hosted Services (“Scheduled Downtime”).</Typography>
      <Typography variant="subtitle2" className={classes.subsection}>8.2. Service Support.</Typography>
      <Typography>FacetsUI will use its best efforts to provide standard support services to the Client (“Support Services”) in accordance with the FacetsUI best practices in effect from time to time through: a) online manuals and other documentation available at https://facetsui.com/docs; FacetsUI may amend such manuals and other documentation from time to time in its sole discretion;</Typography>
      <Typography>8.3. Data Backup. The Services do not replace the need for Client to maintain regular data backups or redundant data archives. <b>FacetsUI HAS NO OBLIGATION OR LIABILITY FOR ANY LOSS, ALTERATION, DESTRUCTION, DAMAGE, CORRUPTION OR RECOVERY OF CLIENT DATA.</b></Typography>
      ...
      <ol type="i">
        {
          [
            ...
            'Client’s services, products, materials, contents of the messages, data, and information used by Client in connection with this Agreement and the Software does not as of the Effective Date, and will not during the Term of this Agreement, operate in any manner that would violate any applicable law or regulation. In the event of any breach, or reasonably anticipated breach, of any of Client’s warranties herein, in addition to any other remedies available at law or in equity, FacetsUI will have the right to immediately, in FacetsUI’s sole discretion, suspend the access and use of the Software if deemed reasonably necessary by FacetsUI to prevent any harm to FacetsUI or its business.'
          ].map((prop, i) => (
            <Typography key={i.toString()} component="li">{prop}</Typography>
          ))
        }
      </ol>
      <Typography variant="subtitle2" className={classes.subsection}>9.2. Warranties by FacetsUI. FacetsUI represents and warrants that:</Typography>
      <ol type="i">
        {
          [
      ...
      <Typography>{'10.1. IN NO EVENT SHALL FACETSUI OR ITS AFFILIATES BE LIABLE FOR ANY SPECIAL, PUNITIVE, EXEMPLARY, DIRECT, INDIRECT, INCIDENTAL, OR CONSEQUENTIAL DAMAGES (INCLUDING, WITHOUT LIMITATION, DAMAGES FOR LOSS OF BUSINESS, LOSS OF REVENUE OR PROFITS, BUSINESS INTERRUPTION, OR LOSS OF DATA) ARISING OUT OF OR IN CONNECTION WITH THIS AGREEMENT OR THE SUBJECT MATTER HEREOF EVEN IF FACETSUI HAS BEEN PREVIOUSLY ADVISED OF THE POSSIBILITY OF SUCH DAMAGES. IN ANY EVENT, IF FACETSUI SHOULD BE HELD LIABLE FOR ANY DAMAGES NOTWITHSTANDING THE TERMS AND CONDITIONS OF THIS AGREEMENT, THE ENTIRE LIABILITY OF FACETSUI (INCLUDING ITS AFFILIATES) WITH RESPECT TO ITS OBLIGATIONS UNDER THIS AGREEMENT OR OTHERWISE, FOR ANY REASON AND UPON ANY CAUSE OF ACTION, REGARDLESS OF THE NUMBER OF ACTIONS OR NUMBER OF LICENSED COPIES OF THE PRODUCTS (AND WHETHER BASED IN CONTRACT, STRICT LIABILITY, NEGLIGENCE OR OTHERWISE) SHALL NOT EXCEED, IN THE AGGREGATE, ONE HUNDRED DOLLARS ($100.00 USD). NO CAUSE OF ACTION WHICH ACCRUED MORE THAN ONE (1) YEAR PRIOR TO THE FILING OF A SUIT ALLEGING SUCH CAUSE OF ACTION MAY BE ASSERTED AGAINST FACETSUI OR ITS AFFILIATES. SOME JURISDICTIONS DO NOT ALLOW THE EXCLUSION OR LIMITATION OF IMPLIED WARRANTIES OR LIABILITY FOR INCIDENTAL OR CONSEQUENTIAL DAMAGES, SO CERTAIN OF THE ABOVE LIMITATIONS OR EXCLUSIONS MAY NOT APPLY TO YOU. NO OTHER LIMITATION CONTAINED IN THIS AGREEMENT SHALL LIMIT FACETSUI\'S LIABILITY TO YOU, TO THE EXTENT SUCH LIMITATION IS PROHIBITED BY APPLICABLE LAW. THE LIMITATIONS OF LIABILITY IN THIS AGREEMENT SHALL SURVIVE EVEN IF ANY EXCLUSIVE OR LIMITED REMEDIES PROVIDED IN THIS AGREEMENT SHOULD FAIL OF THEIR ESSENTIAL PURPOSE.'.toUpperCase()}</Typography>
      <Typography>10.2 You shall indemnify, defend and hold harmless Paddle and its affiliates, and each of their officers, directors, shareholders, agents, representatives, licensees and employees (each, an {'"'}Indemnified Party{'"'}), from and against any and all claims, losses, liabilities, damages, actions, lawsuits and other proceedings, judgments and awards, and costs and expenses (including, without limitation, court costs and reasonable attorneys{'\''} and consultancy fees), arising directly or indirectly, in whole or in part, out of: (a) any breach or threatened breach of this Agreement by You; (b) Your use of the Products; or (c) Your negligence, gross negligence or willful misconduct. An Indemnified Party may participate in the defense by counsel of its own choosing, at its own cost and expense. You shall not settle any claim that adversely affects an Indemnified Party or imposes any obligation or liability on an Indemnified Party without the Indemnified Party{'\''}s prior written consent.</Typography>
      ...
      <Typography>The Client hereby acknowledges and accepts that FacetsUI can use its name and logo in presentations, marketing materials, client lists and financial reports.</Typography>
    </div>
  )
}
