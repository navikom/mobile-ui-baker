...
const Terms = () => {
  ...
  return (
    <div className={classes.root}>
      ...
      <Typography>Muiditor does not process any order payments through the website. All payments are processed securely through Paddle, a third party online payment provider.</Typography>
