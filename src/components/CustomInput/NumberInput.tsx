...
const NumberInput: React.FC<NumberInputProps> = (
  ...
  const input = classNames(classes.input, eClasses.input, className, { [classes.fullWidth]: fullWidth, [classes.error]: error });
  ...
  return (
    <FormControl>
      ...
      <div className={eClasses.wrapper}>
        <IconButton size={size || "medium"} disabled={otherProps.disabled} onClick={handleClick(true)} className={addButton}>
          <Add />
        </IconButton>
        <input
          ...
          {...otherProps}
        />
        <IconButton size={size || "medium"} disabled={otherProps.disabled} onClick={handleClick(false)} className={removeButton}>
          <Remove />
        </IconButton>
      </div>
