  ...
  constructor(id: string) {
    ...
    this.mergeStyles(new Map([
      [MAIN_CSS_STYLE, [
        ...
        new CSSProperty("justifyContent", "center", "center", CSS_CAT_ALIGN_CHILDREN,true, CSS_VALUE_SELECT)
          .setOptions(["inherit", "center", "flex-start", "flex-end", "space-around", "space-between"])
          .setShowWhen(["display", "flex"]),
        new CSSProperty("alignItems", "center", "center", CSS_CAT_ALIGN_CHILDREN,true, CSS_VALUE_SELECT)
