...
export const ACTION_NAVIGATE_REPLACE = 'navigateReplace';
export const ACTION_NAVIGATE_BACK = 'navigateBack';
...
export const EDITOR_ACTIONS = [ACTION_NAVIGATE_TO, ACTION_NAVIGATE_REPLACE, ACTION_NAVIGATE_BACK, ACTION_ENABLE_STYLE, ACTION_DISABLE_STYLE, ACTION_TOGGLE_STYLE];
